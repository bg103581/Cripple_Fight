...
public class CollusionP2 : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            if (player1.gameObject.name == "FedorP2(Clone)" || player1.gameObject.name == "FedorP2skin(Clone)") {
                Debug.Log("checkUP1");
                ...
                if (!playerControlEnemy.blocklow && !playerControlEnemy.blockhigh) {
                    if (myPlayerControl.attackName == "Ulti") {
                        HealthBarP1.Health -= 30f;
                        SuperBarP1.Super += 20f;
                    } else {
                        HealthBarP1.Health -= 6f;
        ...
        {
            if (player1.gameObject.name == "FedorP1(Clone)" || player1.gameObject.name == "FedorP2skin(Clone)") {
